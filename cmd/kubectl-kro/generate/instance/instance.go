...
var Command = &cobra.Command{
	...
	Aliases: []string{},
	Args:    cobra.NoArgs,
	Short:   "Generate a dummy instance",
...
func generateInstance(rg *v1alpha1.ResourceGroup) error {
	...
	emulated := processedRG.Instance.GetEmulatedObject()
	emulated.SetAnnotations(kroGenAnnotations)
	emulated.Object["status"] = nil
	delete(emulated.Object, "status")

	b, err := marshalObject(emulated, optOutputFormat)
	if err != nil {
		return err
	}
