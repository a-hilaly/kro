...
// sameWatchTarget is retained as a package-level shim so existing package tests
// keep working; it delegates to the shared core implementation.
func sameWatchTarget(a, b *WatchRequest) bool { return coordinator.SameWatchTarget(a, b) }
